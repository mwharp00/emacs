...
(defconst remind-keywords
  (sort
   (list "RUN" "REM" "ONCE" "SATISFY" "BEFORE" "UNSET" "OMIT" "FIRST"
...
(defconst remind-builtin-functions
  (sort
   (list "abs" "access" "shell" "args" "asc" "baseyr" "char" "choose" "coerce" "date" "slide"
	 ...
	 "sunrise" "sunset" "lower" "max" "min" "minute" "mon" "moondate" "moontime" "evaltrig"
